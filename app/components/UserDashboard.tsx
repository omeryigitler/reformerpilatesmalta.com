...
export const UserDashboard = ({
    ...
    return (
        <div className="pilates-root min-h-screen flex flex-col items-center p-4 md:p-8 lg:p-10 pb-32 md:pb-40 space-y-6 md:space-y-10 font-sans bg-[#FFF0E5]">
            ...
            <div className="text-center pb-8 opacity-30 text-[10px] font-mono hover:opacity-100 transition-opacity cursor-default">
                <p>Reformer Pilates Malta • V48-SPACING-FIX</p>
            </div>
        </div>
    );
}
