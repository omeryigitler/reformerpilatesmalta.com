    ...
    return (
        <div className="space-y-8 p-4">
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
                ...
                <div className="flex flex-col gap-3 w-full sm:grid sm:grid-cols-3 xl:flex xl:flex-row xl:w-auto">
                    {/* Tarih Filtresi */}
                    <div className="relative w-full xl:w-auto min-w-[160px] group">
                        <button
                    ...
                    <Button onClick={handleDownloadPDF} className="bg-[#CE8E94] hover:bg-[#B57A80] text-white h-12 rounded-xl flex gap-2 w-full xl:w-auto justify-center">
